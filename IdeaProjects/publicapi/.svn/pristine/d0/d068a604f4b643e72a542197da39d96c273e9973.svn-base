...
import net.okdi.mob.service.impl.ExpGatewayServiceImpl;

@Service
public class AlisendNoticeServiceImpl extends BaseService_jdw  implements AlisendNoticeService {
	private static Logger logger = Logger.getLogger(AlisendNoticeServiceImpl.class);
...
//	private static SensitivewordFilter whiteFilter = null;
	 ...
	 */
	@Override
	public String sendAliSms(String accountId,String smsTemplate,String phoneAndWaybillNum,Long memberId,String lng,String lat,boolean isOld,boolean isValidate,
			String voiceUrl,String msgId,Short isNum ,String pickupTime, String pickupAddr, String compName, Short flag, String noticePhone, String md5Hex, String versionCode){//
		...
		/*******************去掉日期 2017年3月4日 15:34:27*原因 为 在之前已经验证过首页群发通知已经验证过,不需要在验证了************************/
		/*if(isValidate){
			//验证繁体字
		...
		String phoneAndWaybillNumNew =  SetSmsContentThree(smsTemplate,phoneAndWaybillNum);
		//正常发送成功的短信才会给存入到黑名单中
		...
		String doSmsSend = smsHttpClient.doAliSendSms
				(accountId,channelNO, phoneAndWaybillNumNew,memberId,memberPhone, flag,voiceUrl,msgId,isNum, pickupTime,pickupAddr, compName, versionCode);
