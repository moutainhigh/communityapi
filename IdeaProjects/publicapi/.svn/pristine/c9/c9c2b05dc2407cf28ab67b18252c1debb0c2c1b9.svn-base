...
@Service
public class SmsTimedServiceImpl implements SmsTimedService {
    ...
    public String updateSmsTimedInfo(Long id, String number, String phone, Integer flag) {
        ...
        map.put("phone",phone);
        map.put("flag",flag);
        String response = openApiHttpClient.doPassSendStr("smsTimedController/updateNumOrPhone/", map);
    ...
    public String deleteSmsTimedInfo(Long id) {
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("id",id);
        String response = openApiHttpClient.doPassSendStr("smsTimedController/deleteSmsTimedInfo/", map);
        if(PubMethod.isEmpty(response)){
    ...
    public String sendSmsTimed(Long id) {
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("id",id);
        String response = openApiHttpClient.doPassSendStr("smsTimedController/sendSmsTimed/", map);
        if(PubMethod.isEmpty(response)){
    ...
    public String timeDelaySendSms(String groupName, Long warnTime,
        ...
        map.put("type",type);
        String response = openApiHttpClient.doPassSendStr("smsTimedController/timeDelaySendSms", map);
        return response;
    }
    ...
    public String aliTimeDelaySendSms(String groupName, Long warnTime, Long sendTime,
        ...
        String response = openApiHttpClient.doPassSendStr("smsTimedController/aliTimeDelaySendSms", map);
        return response;
    }
    ...
    public String timeDelaySendSmsList(Long memberId) {
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("memberId",memberId);
        String response = openApiHttpClient.doPassSendStr("smsTimedController/timeDelaySendSmsList", map);
        return response;
    }
    ...
    public String DelaySendSmsDetial(Long groupId) {
        ...
        String response = openApiHttpClient.doPassSendStr("smsTimedController/delaySendSmsDetial", map);
        return response;
    }
    ...
    public String updateSmsWarnTime(Long groupId, Long warnTime,String type) {
        ...
        map.put("warnTime",warnTime);
        map.put("type",type);
        String response = openApiHttpClient.doPassSendStr("smsTimedController/updateSmsWarnTime", map);
        return response;
    }
    ...
    public String deleteSmsList(String ids) {
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("ids", ids);
        String response = openApiHttpClient.doPassSendStr("smsTimedController/deleteSmsList", map);
        return response;
    }
