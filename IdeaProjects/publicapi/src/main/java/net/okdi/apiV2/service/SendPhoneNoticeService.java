...
public interface SendPhoneNoticeService {
	/**
	 ...
	 * @return
	 */
	public String sendPhoneNotice(String accountId,String phoneAndNum,String noticePhone,Long memberId,String content,Short flag,String pickupTime,String pickupAddr, String compName, String md5Hex);
