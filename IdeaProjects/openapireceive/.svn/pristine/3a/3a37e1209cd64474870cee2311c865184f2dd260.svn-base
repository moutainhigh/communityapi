...
/**
 * 
 * <p>Title:排行榜按月统计取派件数 </p>
 * <p>Description: </p>
 * <p>Company: net.okdit</p> 
 * @author jianxin.ma
 * @date 2016-7-1
 */
@Document(collection="parMonthCount")
public class ParMonthCount {

	private Long memberId;//快递员Id
	
	private Long provinceId;//快递员所属省份Id(默认查询省内排行用)
	
	private String strMouth;//月份  格式:2016-01
	...
	public void setStrMouth(String strMouth) {
		this.strMouth = strMouth;
	}
