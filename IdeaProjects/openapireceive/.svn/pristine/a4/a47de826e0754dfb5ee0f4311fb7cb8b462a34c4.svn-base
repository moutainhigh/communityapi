...
public class VerifyUtil {
    ...
    /** 手机 */
    private static final String V_MOBILE="^(1[345678]\\d{9})|((0\\d{2,3}(\\-)?)?\\d{8})|(400[\\-\\d]+)|(800[\\-\\d]+)$";
     ...
     * @return 如果是符合格式的字符串,返回 <b>true </b>,否则为 <b>false </b>
     */
    public static boolean isNumber_length(String value){
     ...
     * @return 如果是符合格式的字符串,返回 <b>true </b>,否则为 <b>false </b>
     */
    public static boolean isTwo_point(String value){
